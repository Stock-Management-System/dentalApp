        ...
        <section className="flex pt-24 w-[100%] items-center min-h-screen z-20 lg:px-20 bg-transparent xs:flex-col lg:flex-row lg:justify-evenly mb-10 ">
          <div className="lg:w-1/2 xl:w-auto xs:w-5/6 xs:text-center lg:text-left  pb-10 z-20">
            ...
            <p className="text-18 lg:max-w-xl mt-5">
              6000 den fazla hekim ve 900 den fazla diş kliniği ile dentrey
        ...
        <section className="w-[100%]  px-[100px] bg-container z-20 sm:mt-14 lg:mt-28 pb-12">
          <div className="text-center mb-24">
            ...
            <p className="xs:w-5/6 lg:w-1/2 m-auto text-center text-gray leading-normal text-18 font-light">
              ...
              istediğiniz klinikten istediğiniz zaman randevu alabilirsiniz.
            </p>
          </div>
          <div className="flex justify-evenly gap-20 text-center xs:flex-col lg:flex-row pb-20">
            <div>
              ...
              <p className="text-[16px] text-mainPageP pb-5 leading-6">
                Yüzlerce diş hekimi arasından sizin için en uygun olanı seçin.
              </p>
            </div>
            <div>
              ...
              <p className="text-[16px] text-mainPageP pb-5 leading-6">
                Sizin için en uygun zamanı seçerek tedavi zamanını kendiniz
                planlayın.
              </p>
            </div>
            <div>
              ...
              <p className="text-[16px] text-mainPageP pb-5 leading-6">
                Kendi belirlediğiniz doktora, kendi belirlediğiniz zamanda
                tedavi olun.
              </p>
            </div>
          </div>

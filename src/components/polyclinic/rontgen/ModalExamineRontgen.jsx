                                    ...
                                    <div className="md:grid md:grid-cols-3 md:gap-3">
                                        <div className="md:col-span-2">
                                            <div className="px-4 sm:px-0">
                                                ...
                                                <div className="relative mt-1 flex justify-center items-center rounded-md border-2 border-dashed border-gray-300 h-[28rem] px-6 pt-5 pb-6">
                                                    <TransformWrapper
                                                        initialScale={1}
                                                    ...
                                                    >
                                                        {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                                                            <>
                                                                <div className="z-50 absolute left-2 top-2 flex flex-col gap-1">
                                                                ...
                                                                <TransformComponent>
                                                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOx1hmyt1BElr60XudF5Bes9O4ymDQ9Rr2_g&usqp=CAU" width={620} alt="röntgen" className='object-fill hover:object-scale-down' />
                                                                </TransformComponent>
                                                            </>
                                                        )}
                                                    </TransformWrapper>

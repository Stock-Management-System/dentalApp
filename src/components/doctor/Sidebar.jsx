                ...
                <div>
                    ...
                    <ul className="menu  w-50 mt-24   text-white" onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
                        <li className="hover:bg-linkhover transition duration-0 hover:duration-200 mt-0.5">
                            <Link to='/doktorlar' className=" pl-9" >
                                <FaTooth className="text-turquaz text-22" />
                                <span className={`whitespace-nowrap ${open ? 'opacity-100' : 'opacity-0'} transition-all ease-in-out duration-200`}>Sayfam</span>
                            </Link>
                        </li>
                        <li className="hover:bg-linkhover transition duration-0 hover:duration-200 mt-0.5">
                            <Link to='/doktorlar/randevular' className=" pl-9">
                        ...
                        <li className="hover:bg-linkhover transition duration-0 hover:duration-200  mt-0.5">
                            <Link to='/doktorlar/hastalarım' className=" pl-9">
                                <IoFileTrayOutline className="text-turquaz text-22" /><span className={`whitespace-nowrap ${open ? 'opacity-100' : 'opacity-0'} transition-all ease-in-out duration-200`}>Hastalarım</span>
                            </Link>
                        </li>
                        {/* <li className="hover:bg-linkhover transition duration-0 hover:duration-200 mt-0.5 ">
                        ...
                        <li className="hover:bg-linkhover transition duration-0 hover:duration-200 mt-0.5 ">
                            <Link to='/doktorlar/ayarlar' className=" pl-9">

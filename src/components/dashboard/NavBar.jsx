...
const NavBar = ({ setShowRegister }) => {
  ...
  return (
    <div
      style={
        bgColor
          ? { backgroundColor: 'white' , boxShadow: '0 4px 10px 0 rgba(0,0,0,.03)'}
          : { backgroundColor: 'transparent' }
      }
      className="navbar w-full top-0 left-0 xs:px-5 md:px-16 lg:px-32 fixed z-50 hover:bg-container"
    >
